...
void BaseWriter::enable()
{
    ...
    logInfo(DDSRECORDER_BASE_WRITER, "Enabling writer.");
    ...
    {
        logError(DDSRECORDER_BASE_WRITER, "Error opening a new output file: " << e.what());
        on_disk_full_();
    }
...
void BaseWriter::disable()
{
    ...
    logInfo(DDSRECORDER_BASE_WRITER, "Disabling writer.");
